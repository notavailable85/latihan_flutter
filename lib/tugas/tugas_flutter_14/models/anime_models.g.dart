...
AnimeModels _$AnimeModelsFromJson(Map<String, dynamic> json) => AnimeModels(
...
Map<String, dynamic> _$AnimeModelsToJson(AnimeModels instance) =>
...
const _$DatumTypeEnumMap = {DatumType.MOVIE: 'Movie', DatumType.TV: 'TV'};
...
const _$RatingEnumMap = {
  ...
  Rating.PG_CHILDREN: 'PG - Children',
